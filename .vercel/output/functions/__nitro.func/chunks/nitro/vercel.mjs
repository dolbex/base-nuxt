...
const _lazy_iSZGSq = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_iSZGSq, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_iSZGSq, lazy: true, middleware: false, method: undefined }
];
